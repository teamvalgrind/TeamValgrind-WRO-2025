...
#define IN1 16
#define PIN_SERVO 2
#define PIN_BOTON 15 // Pin para botón de inicio
...
const unsigned long DURACION_GIRO_I = 420; // 460 funciona
const unsigned long DURACION_GIRO_D = 350; // 500
const unsigned long TIEMPO_ESPERA_GIRO = 300;  // 2500 ms-
...
void setup() {
  ...
  myservo.write(98);  // Servo centrado
...
void Izquierda() {
  ...
  myservo.write(96);  // Centrar servo
  digitalWrite(IN1, LOW);
